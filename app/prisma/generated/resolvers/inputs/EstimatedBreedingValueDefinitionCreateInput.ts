...
import { EstimatedBreedingValueResultCreateNestedManyWithoutEbvInput } from "../inputs/EstimatedBreedingValueResultCreateNestedManyWithoutEbvInput";
import { EbvCategory } from "../../enums/EbvCategory";
import { Measurement } from "../../enums/Measurement";
import { Units } from "../../enums/Units";

@TypeGraphQL.InputType("EstimatedBreedingValueDefinitionCreateInput", {})
export class EstimatedBreedingValueDefinitionCreateInput {
  ...
  @TypeGraphQL.Field(
    (_type) => EstimatedBreedingValueResultCreateNestedManyWithoutEbvInput,
    {
      nullable: true,
    },
  )
