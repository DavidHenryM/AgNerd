...
import { LivestockUnitUpdateToOneWithWhereWithoutTreatmentsInput } from "../inputs/LivestockUnitUpdateToOneWithWhereWithoutTreatmentsInput";
...
export class LivestockUnitUpdateOneRequiredWithoutTreatmentsNestedInput {
  ...
  @TypeGraphQL.Field(
    (_type) => LivestockUnitUpdateToOneWithWhereWithoutTreatmentsInput,
    {
      nullable: true,
    },
  )
  update?: LivestockUnitUpdateToOneWithWhereWithoutTreatmentsInput | undefined;
}
