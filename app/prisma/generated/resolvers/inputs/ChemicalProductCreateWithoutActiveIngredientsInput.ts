...
import { ChemicalTreatmentCreateNestedManyWithoutProductInput } from "../inputs/ChemicalTreatmentCreateNestedManyWithoutProductInput";
...
@TypeGraphQL.InputType("ChemicalProductCreateWithoutActiveIngredientsInput", {})
export class ChemicalProductCreateWithoutActiveIngredientsInput {
  ...
  @TypeGraphQL.Field(
    (_type) => ChemicalTreatmentCreateNestedManyWithoutProductInput,
    {
      nullable: true,
    },
  )
