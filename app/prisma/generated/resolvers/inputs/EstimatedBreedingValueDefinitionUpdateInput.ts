...
import { EstimatedBreedingValueResultUpdateManyWithoutEbvNestedInput } from "../inputs/EstimatedBreedingValueResultUpdateManyWithoutEbvNestedInput";
import { NullableStringFieldUpdateOperationsInput } from "../inputs/NullableStringFieldUpdateOperationsInput";
import { StringFieldUpdateOperationsInput } from "../inputs/StringFieldUpdateOperationsInput";

@TypeGraphQL.InputType("EstimatedBreedingValueDefinitionUpdateInput", {})
export class EstimatedBreedingValueDefinitionUpdateInput {
  ...
  @TypeGraphQL.Field(
    (_type) => EstimatedBreedingValueResultUpdateManyWithoutEbvNestedInput,
    {
      nullable: true,
    },
  )
