...
import { ActiveIngredientUpdateManyWithoutProductNestedInput } from "../inputs/ActiveIngredientUpdateManyWithoutProductNestedInput";
...
@TypeGraphQL.InputType("ChemicalProductUpdateWithoutChemicalTreatmentInput", {})
export class ChemicalProductUpdateWithoutChemicalTreatmentInput {
  @TypeGraphQL.Field(
  ...
  @TypeGraphQL.Field(
    (_type) => ActiveIngredientUpdateManyWithoutProductNestedInput,
    {
      nullable: true,
    },
  )
