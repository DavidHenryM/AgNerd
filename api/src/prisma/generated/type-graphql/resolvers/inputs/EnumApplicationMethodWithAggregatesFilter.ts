...
import { NestedEnumApplicationMethodWithAggregatesFilter } from "../inputs/NestedEnumApplicationMethodWithAggregatesFilter";
import { NestedIntFilter } from "../inputs/NestedIntFilter";
import { ApplicationMethod } from "../../enums/ApplicationMethod";

@TypeGraphQL.InputType("EnumApplicationMethodWithAggregatesFilter", {
  isAbstract: true
})
export class EnumApplicationMethodWithAggregatesFilter {
  ...
  @TypeGraphQL.Field(_type => NestedEnumApplicationMethodWithAggregatesFilter, {
    nullable: true
  })
