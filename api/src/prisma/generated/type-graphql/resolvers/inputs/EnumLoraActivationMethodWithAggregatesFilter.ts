...
import { NestedEnumLoraActivationMethodWithAggregatesFilter } from "../inputs/NestedEnumLoraActivationMethodWithAggregatesFilter";
import { NestedIntFilter } from "../inputs/NestedIntFilter";
import { LoraActivationMethod } from "../../enums/LoraActivationMethod";

@TypeGraphQL.InputType("EnumLoraActivationMethodWithAggregatesFilter", {
  isAbstract: true
})
export class EnumLoraActivationMethodWithAggregatesFilter {
  ...
  @TypeGraphQL.Field(_type => NestedEnumLoraActivationMethodWithAggregatesFilter, {
    nullable: true
  })
