...
@TypeGraphQL.InputType("NestedEnumPregnancyTestTypeWithAggregatesFilter", {
  isAbstract: true
})
export class NestedEnumPregnancyTestTypeWithAggregatesFilter {
  ...
  @TypeGraphQL.Field(_type => NestedEnumPregnancyTestTypeWithAggregatesFilter, {
    nullable: true
  })
