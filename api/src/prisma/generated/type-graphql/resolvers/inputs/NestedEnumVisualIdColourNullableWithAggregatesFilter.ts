...
@TypeGraphQL.InputType("NestedEnumVisualIdColourNullableWithAggregatesFilter", {
  isAbstract: true
})
export class NestedEnumVisualIdColourNullableWithAggregatesFilter {
  ...
  @TypeGraphQL.Field(_type => NestedEnumVisualIdColourNullableWithAggregatesFilter, {
    nullable: true
  })
